...
export function MicButtonWithVisualizer({
  ...
  const toggleMicrophone = async () => {
    ...
    if (agoraTrack) {
      ...
      try {
        ...
        agoraTrack.setEnabled(isEnabledRef.current);
      }
    } else {
  ...
  return (
    <button
      ...
      className={`group relative flex h-16 w-16 items-center justify-center rounded-full border-2 shadow-lg transition-all duration-300 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none ${className}`}
      style={{
